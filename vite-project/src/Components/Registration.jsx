...
const Registration = () => {
      ...
      case "firstName":
        if (value.length < 4) {
          validationErrors.firstName =
            "First name should be minimum 5 characters";
      ...
      case "lastName":
        if (value.length < 4) {
          validationErrors.lastName =
            "Last name should be minimum 5 characters";
        } else if (value.length > 15) {
          validationErrors.lastName =
            "Last name should be maximum 15 characters";
        } else {
  ...
  const handleSubmit = (e) => {
    ...
    if (isValid) {
      axios
        .post("http://localhost:8080/api/employees", formData, { headers })
        .then(() => {
  ...
  return (
    <div className="container col-md-6 offset-md-2">
      <div className="row">
        <div className="col md-8 offset-md-5 ">
          <div className="signup-form">
            ...
            >
              <h4 className="text-center md-5 text-secondary">
                Create Your Account
              </h4>
